...
function spawn() {
    ...
    let seed = rnd(100)
    let tx = rnd(innerWidth - 1000); 
    let ty = rnd(innerHeight - 1000);
    let x = rnd(innerWidth -1000)
    let y = rnd(innerHeight - 1000)
    let kx = rnd(0.8, 0.8)
    let ky = rnd(0.8, 0.8)
    let walkRadius = pt(rnd(10,10), rnd(10,10))
   let r = innerWidth / rnd(100, 200);
    ...
    x += min(innerWidth/100, (fx - x)/30)
    y += min(innerWidth/100, (fy - y)/30)
